...
\def\Who{Karl Benedict} % Your name
\def\What{, PhD} % Your title
\def\Where{College of University Libraries and Learning Sciences} % Your department/institution
\def\Address{MSC05 3020, 1 University of New Mexico} % Your address
\def\CityZip{Albuquerque, NM 87131} % Your city, zip code, country, etc
\def\Email{E-mail: kbene@unm.edu} % Your email address
\def\TEL{Phone: (505) 301-4541} % Your phone number
\def\URL{URL: http://libguides.unm.edu} % Your URL
...
\address{
\includegraphics[width=1.5in]{UNMLogo.jpg} % Include the logo of your institution
...
\hfill\makebox[0ex][r]{\bf \Who \What }\hspace{.08in} % Print your name and title with a little whitespace to the right
~\\[-0.11in] % Reduce the whitespace above the horizontal rule
\hspace{1.5in}\vhrulefill{0.5pt} \\ % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
\hspace{1.75in}\parbox[t]{3.5in}{ % Create a box for your details underneath the horizontal rule on the right
\footnotesize % Use a smaller font size for the details
\raggedleft % right align the text within the details box
...
{\centering\fromaddress \vspace{1.5in} \\ % Print the header and from address here, add whitespace to move date down
\hspace{.0in}$date$\hspace*{\fill}\par} % Print today's date, remove \today to not display it
